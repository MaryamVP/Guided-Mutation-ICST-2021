...
class Code2VecModel(Code2VecModelBase):
    def __init__(self, config: Config):
        ...
        # self.keras_eval_model: Optional[keras.Model] = 'keke.h5'
    ...
    def _compile_keras_model(self, optimizer=None):
        ...
        # return self.keras_train_model , self.keras_eval_model
    ...
    def train(self):
        ...
        # print(train_data_input_reader.get_dataset())
        ...
        # training_history.save('test.h5')
        # print('8'*80)
        self.log(training_history)
        # print(self.keras_train_model)
        # return self.keras_train_model
        return self.keras_train_model

    def evaluate(self) -> Optional[ModelEvaluationResults]:
        print('ALIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIZZZZZZZZZZz')
        # self.keras_eval_model = new_model
        val_data_input_reader = self._create_data_reader(estimator_action=EstimatorAction.Evaluate)
        print(val_data_input_reader)
        print('ALIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIZZZZZZZZZZz')
    ...
    # def save_model(self):
    #     self.save('ves-models/correct_mode.h5')
