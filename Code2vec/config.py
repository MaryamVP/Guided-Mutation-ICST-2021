...
class Config:
    ...
    def arguments_parser(cls) -> ArgumentParser:
        ...
        parser.add_argument("-d", "--data", dest="data_path", #default = '/Users/Vesal/Desktop/code2vec-master 2/data/test/test',
                            help="path to preprocessed dataset", required=False)
        parser.add_argument("-te", "--test", dest="test_path", #default = '/Users/Vesal/Desktop/code2vec-master 2/data/test/test.test.c2v',
                            help="path to test file", metavar="FILE", required=False)#, default='')
        parser.add_argument("-s", "--save", dest="save_path", default = '/Users/Vesal/Desktop/code2vec-master 2/models/new_keras_models',
        ...
        parser.add_argument("-l", "--load", dest="load_path", #default= '/Users/Vesal/Desktop/code2vec-master 2/models/new_keras_models',#default = '/Users/Vesal/Desktop/code2vec-master 2/ves-models', #default = '/Users/Vesal/Desktop/DeepMutation++/rnn_mutation/src/lstm-mutants/WPR_input_0.05_0_0.1_1.h5',#default="/Users/Vesal/Desktop/code2vec-master 2/models/java-small-trained/saved_model_iter1",
    ...
    def set_defaults(self):
        ...
        self.TRAIN_BATCH_SIZE = 200#1024
